...
Introduction
========================================================
Data sets from Van Meter et al. 2014 and Van Meter et al. 2015.
...
#the data sets
##################
# import data from Soil organic matter toad paper
  RDATA <- read.table(paste(frogsoildir,"RDATA.csv",sep=""), header = TRUE, sep = ",")
# import data from VanMeter et al. 2014 Archives of Environmental Contamination 
# and VanMeter et al. 2014 Environmental Pollution   
good_data <- read.table(paste(amphibdir,"good_data.csv",sep=""), header = TRUE, sep = ",")  
```
