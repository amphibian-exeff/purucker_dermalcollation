...
The purpose of this script is to combine the data sets from Van Meter et al. (2014, 2015, 2016, 2018) and Glinski (2018a, b, c, 2019), and Henson-Ramsey (2008) to create a collated database of amphibian dermal exposure data.    
...
The application rate values (app_rate_g_cm2) were updated for the pesticides, the temporarily dropped soil concentrations were updated to the current data set, and the species names were standardized.
```{r eval = TRUE, echo = TRUE, include = TRUE}
