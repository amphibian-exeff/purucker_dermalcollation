...
dag2016_metabolite_file <- paste(amphibdir_data_in,"dag2016_data_metabolite.csv", sep="")
file.exists(dag2016_dehy_file)
dag2016_dehy0 <- read.table(dag2016_dehy_file, header = TRUE, sep = ",")
dim(dag2016_dehy0)
summary(dag2016_dehy0)
...
dag2016_dehy4$tissue_conc_ugg[update_chloro] <-  100.0
...
Revise glinski_metabolites to merge with van meter data sets
...
#View(dag2016_dehy5)
#temporarily set chloro parent to 100 pending summing daughter metabolites
dag2016_dehy4$tissue_conc_ugg[update_chloro] <-  0.0001 #100.0
