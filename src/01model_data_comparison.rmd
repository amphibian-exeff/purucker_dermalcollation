...
Summary of app_rate, by study
```{r eval = TRUE, echo = FALSE}
# summary(combined_data$app_rate_g_cm2[combined_data$source == "rvm2015"])
# summary(combined_data$app_rate_g_cm2[combined_data$source == "rvm2016"])
# summary(combined_data$app_rate_g_cm2[combined_data$source == "dag_dehydration"])
# summary(combined_data$app_rate_g_cm2[combined_data$source == "hr2008"])
# summary(combined_data$app_rate_g_cm2[combined_data$source == "dag_metabolites"])
# summary(combined_data$app_rate_g_cm2[combined_data$source == "dag_biomarker"])
# summary(combined_data$app_rate_g_cm2[combined_data$source == "rvm2017"])
# summary(combined_data$app_rate_g_cm2[combined_data$source == "dag_dermal_routes"])
```
...
```{r eval = TRUE, echo = FALSE, include = FALSE}
summary(combined_data$body_weight_g[combined_data$source == "rvm2015"])
summary(combined_data$body_weight_g[combined_data$source == "rvm2016"])
summary(combined_data$body_weight_g[combined_data$source == "dag_dehydration"])
summary(combined_data$body_weight_g[combined_data$source == "hr2008"])
summary(combined_data$body_weight_g[combined_data$source == "dag_metabolites"])
summary(combined_data$body_weight_g[combined_data$source == "dag_biomarker"])
summary(combined_data$body_weight_g[combined_data$source == "rvm2017"])
summary(combined_data$body_weight_g[combined_data$source == "dag_dermal_routes"])
```
...
```{r eval = TRUE, echo = FALSE, include = FALSE}
summary(combined_data$tissue_conc_ugg[combined_data$source == "rvm2015"])
summary(combined_data$tissue_conc_ugg[combined_data$source == "rvm2016"])
summary(combined_data$tissue_conc_ugg[combined_data$source == "dag_dehydration"])
summary(combined_data$tissue_conc_ugg[combined_data$source == "hr2008"])
summary(combined_data$tissue_conc_ugg[combined_data$source == "dag_metabolites"])
summary(combined_data$tissue_conc_ugg[combined_data$source == "dag_biomarker"])
summary(combined_data$tissue_conc_ugg[combined_data$source == "rvm2017"])
summary(combined_data$tissue_conc_ugg[combined_data$source == "dag_dermal_routes"])
```
...
~ Look more at the histograms of the TIM Ratios
```{r eval = TRUE, echo = FALSE}
# RVM 2015 histograms

# RVM 2015 
hist(combined_data$tim_direct_default_ratios[combined_data$source == "rvm2015"])

# RVM 2015 and tissue conc<.10
hist(combined_data$tim_direct_default_ratios[combined_data$source == "rvm2015" & combined_data$tissue_conc_ugg < 0.10])
...
# RVM 2016 
hist(combined_data$tim_direct_default_ratios[combined_data$source == "rvm2016"])

# RVM 2016 and tissue conc<.10
hist(combined_data$tim_direct_default_ratios[combined_data$source == "rvm2016" & combined_data$tissue_conc_ugg < 0.10])
...
# RVM 2017 
hist(combined_data$tim_direct_default_ratios[combined_data$source == "rvm2017"])

# RVM 2017 and tissue conc<.10
hist(combined_data$tim_direct_default_ratios[combined_data$source == "rvm2017" & combined_data$tissue_conc_ugg < 0.10])
