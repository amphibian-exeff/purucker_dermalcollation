...
* Henson-Ramsey 2008 data consists of exposure to malathion for Tiger salamanders.
...
Scatterplots were created to visualize the model's performance, grouped by specific variables (study, chemical, application type), respectively.
```{r eval = TRUE, echo = TRUE, include = TRUE}
