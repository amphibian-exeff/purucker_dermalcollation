...
~~~ briefly talk about each scatterplot 
```{r eval = TRUE, echo = TRUE, include = TRUE}
...
~~ is it okay that the sa_tim_default_frac is same as TIM Default? 
```{r eval = TRUE, echo = TRUE, include = TRUE}
...
~~~ briefly talk about each of the scatterplots
```{r eval = TRUE, echo = TRUE, include = TRUE}
# create scatterplot, categorized by study
...
Again, we show scatterplots comparing the modeled vs. measured values, this time comparing models side-by-side. A model along the 1:1 line would display perfect agreement with the measured values.  
