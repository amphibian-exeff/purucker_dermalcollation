...
The figure compares DUST model direct spray modelled values with the measured tissue concentration from direct spray of five active ingredients. The model underestimates body burdens for atrazine, triadimefon and fipronil exposures.
...
The figure compares DUST model indirect foliage uptake modelled values with the measured indirect uptake for three active ingredients. The modelled values are conservative for all the active ingredients.
...
The figure compares DUST model indirect foliage uptake modelled values with the measured direct uptake for five active ingredients. The modelled values are conservative for all the active ingredients.


Plot comparing direct vs. indirect DUST model output. The inputs are the combined data set of application rates and body weights from the amphibians exposed to derive body burdens. Indirect dermal uptake from foliage results are a magnitude of order higher than direct dermal spray uptake. 

```{r fig.width=7, fig.height=6}
#plot comparing direct vs. indirect DUST model output
plot(combined_data2$dermal_foliage_dose_out~combined_data2$dermal_spray_dose_out, col=combined_data2$Chemical)
legend(x="topright", legend = levels(combined_data2$Chemical), col=1:nlevels(combined_data2$Chemical), pch=16)
abline(0,1, col="red")
```
...
Modeled direct overspray of tissue concentration from DUST underestimates measured tissue concentration of some species body burdens when compared to measured direct exposure body burdens.
...
Modeled indirect overspray of tissue concentration from DUST underestimates measured tissue concentration of some species body burdens when compared to measured direct exposure body burdens.
...
Modeled indirect overspray of tissue concentration from DUST is conservative of measured tissue concentration of all species body burdens when compared to measured indirect exposure body burdens.
...
legend(x="topright", legend = levels(combined_data2$Species), col=1:nlevels(combined_data2$Species), pch=16)
#plot comparing direct vs. indirect DUST model output
plot(combined_data2$dermal_foliage_dose_out~combined_data2$dermal_spray_dose_out, col=combined_data2$Species, pch=16)
